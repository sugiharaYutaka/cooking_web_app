...
<body>
    ...
    <style>
        <div class="col-2 d-flex">< !--<a><img class="logo" src="{{asset('image/logo.png')}}"></a>--><button type="button" style="border: none; background: transparent;" class="btn"><a href="{{ route('top') }}"><img class="logo" src="{{asset('image/logo.png')}}"></a></button></div><div class="col-lg-1"></div><div class="col-lg-1"><button type="button" class="btn"><a href="{{ route('study') }}" class="no-underline text-dark d-block"><img src="{{ asset('image/study.png') }}" class="footericon"><br>勉強</a></button></div><div class="col-lg-1"><button type="button" class="btn"><a href="{{ route('recipe') }}" class="no-underline text-dark d-block"><img src="{{ asset('image/recipe.png') }}" class="footericon"><br>献立</a></button></div><div class="col-lg-1"><button type="button" class="btn"><a href="{{ route('sns') }}" class="no-underline text-dark d-block"><img src="{{ asset('image/SNS.png') }}" class="footericon"><br>SNS</a></button></div><div class="col-lg-1"><button type="button" class="btn"><a href="{{ route('dictionary') }}" class="no-underline text-dark d-block"><img src="{{ asset('image/dictionary.png') }}" class="footericon"><br>知識箱</a></button></div><div class="col-lg-4"></div><div class="col-1">@guest <a href="#modalProfile" data-bs-toggle="modal"><img src="{{ asset('image/user_icon.png') }}" class="user-icon" style="width: 48px; height: 48px;" /></a>@else <a href="#modalProfile" data-bs-toggle="modal"><img src="{{ asset('') }}" class="user-icon" style="width: 48px; height: 48px;" /></a>@endguest </div></nav></div></div></div><style>@media(max-width:750px) {
            .footericon {
