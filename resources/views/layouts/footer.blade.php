        ...
        <div class="container">
            <div class="row text-center my-1">
                <div class="btn-group" role="group" aria-label="Button group">
                    <button type="button" class="btn"><a href="{{ route('recipebookmark') }}" class="no-underline text-dark d-block"><img src="{{ asset('image/bookmark.png') }}" class="footericon"><br>ブックマーク</a></button>
