...
<body class='mb-5'>
    <div class="container" style="padding-top: 100px;">
        ...
        <div class="tab-content" id="myTabContent">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('ComingSoon') }}" class="no-underline text-dark">
                                    <div class="custom-image-size">
                                        <img src="{{ asset('image/knowledge/chopsticks.jpg') }}" class="card-img-top custom-image-size d-flex justify-content-center">
                                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('ComingSoon') }}" class="no-underline text-dark">
                                    <div class="custom-image-size">
                                        <img src="{{ asset('image/knowledge/tongu.jpeg') }}" class="card-img-top custom-image-size d-flex justify-content-center">
                                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('ComingSoon') }}" class="no-underline text-dark">
                                    <div class="custom-image-size">
                                        <img src="{{ asset('image/knowledge/bowl.jpg') }}" class="card-img-top custom-image-size d-flex justify-content-center">
                                    </div>
                                    料理の下ごしらえに使う道具。 <br>　
                            </div>
                            </a>
            ...
            <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab" style="padding-top: 10px;">
                <!-- 調味料 -->
                <div class="row">
                    <!-- Tab 1のコンテンツを3x3のグリッドで配置 -->
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('kitchenknife') }}" class="no-underline text-dark">
                                    <div class="custom-image-size">
                                        <img src="{{ asset('image/knowledge/oil.jpeg') }}" class="card-img-top custom-image-size d-flex justify-content-center">
                                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('skillet') }}" class="no-underline text-dark">
                                    <div class="custom-image-size">
                                        <img src="{{ asset('image/knowledge/cooking sake.jpg') }}" class="card-img-top custom-image-size d-flex justify-content-center">
                                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('ComingSoon') }}" class="no-underline text-dark">
                                    <div class="custom-image-size">
                                        <img src="{{ asset('image/knowledge/soy sauce.jpg') }}" class="card-img-top custom-image-size d-flex justify-content-center">
                                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('ComingSoon') }}" class="no-underline text-dark">
                                    <div class="custom-image-size">
                                        <img src="{{ asset('image/knowledge/pepper.jpeg') }}" class="card-img-top custom-image-size d-flex justify-content-center">
                                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('ComingSoon') }}" class="no-underline text-dark">
                                    <div class="custom-image-size">
                                        <img src="{{ asset('image/knowledge/sweetsake.jpeg') }}" class="card-img-top custom-image-size d-flex justify-content-center">
                                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('ComingSoon') }}" class="no-underline text-dark">
                                    <div class="custom-image-size">
                                        <img src="{{ asset('image/knowledge/sugar.jpg') }}" class="card-img-top custom-image-size d-flex justify-content-center">
                                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('ComingSoon') }}" class="no-underline text-dark">
                                    <div class="custom-image-size">
                                        <img src="{{ asset('image/knowledge/salt.jpeg') }}" class="card-img-top custom-image-size d-flex justify-content-center">
                                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('ComingSoon') }}" class="no-underline text-dark">
                                    <div class="custom-image-size">
                                        <img src="{{ asset('image/knowledge/miso.jpeg') }}" class="card-img-top custom-image-size d-flex justify-content-center">
                                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('ComingSoon') }}" class="no-underline text-dark">
                                    <div class="custom-image-size">
                                        <img src="{{ asset('image/knowledge/vinegar.jpg') }}" class="card-img-top custom-image-size d-flex justify-content-center">
                                    </div>
