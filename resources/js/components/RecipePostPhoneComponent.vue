        ...
        <div class="card mx-1 p0">
            <div class="container-fluid p-0">
                <div class="row m-0">
                    ...
                    <div class="col">
                        <div class="mx-2">
                            <textarea :class="formClass['ingredients']" placeholder="醤油:大さじ3" v-model="ingredients"
                                style="margin: 0;padding: 0;"></textarea>
                    ...
                    <div v-for="index in stepCount">
                        <div class="card my-2 mx-1">
                            <div class="container mt-2">
                                <div class="row">
                                    <div class="col-12">
                                        <label class="form-label2 ">{{ '工程' + index }}</label>
                                    ...
                                    <div class="col-12 mt-3">
                                        <label class="form-label2 ">工程写真</label>
                                        <br>
                    ...
                    <div class="col">
                        <div class="mx-2">
                            <textarea :class="formClass['point']" placeholder="鶏肉を焼く時に皮を下にして焼くのがおすすめです。" v-model="point"
                                style="margin: 0;padding: 0;"></textarea>
